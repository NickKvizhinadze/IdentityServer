...
namespace CNP.Identity.Controllers
{
    ...
    {
        private readonly UserManager<CnpUser> _userManager;
        ...
        public ExternalController(
            UserManager<CnpUser> userManager,
        ...
        private async Task<CnpUser> AutoProvisionUser(string provider, string providerUserId, IEnumerable<Claim> claims)
        {
            var user = new CnpUser(Guid.NewGuid().ToString());
