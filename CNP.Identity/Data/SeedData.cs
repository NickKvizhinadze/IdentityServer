...
namespace CNP.Identity.Data
{
    public class SeedData
    {
        ...
        {
            var enableSeed = bool.Parse(configuration["AppSettings:EnableSeed"]);
            if (!enableSeed)
            {
                return;
            }
            ...
            services.AddIdentity<CnpUser, IdentityRole>()
        ...
        {
            var userMgr = scope.ServiceProvider.GetRequiredService<UserManager<CnpUser>>();
